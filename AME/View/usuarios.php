...
"<div class=\"col-sm-12\">
    ...
    <div class=\"col-sm-12\">  
                ...
                <div class=\"col-sm-6\">      
                    ...
                    <input type=\"hidden\" name=\"inp-id\" id=\"inp-id\">	
                        ...
                        <div class=\"col-sm-7\">
                         ...
                         <div class=\"col-sm-5\">
                            <label>CPF</label><br>                    
                                <div class=\"input-group\">
                                    {$f->input("text", "form-control cpf-mask", "inp-cpf-usuario", "inp-cpf-usuario", "", "CPF", "", "Digite o CPF","",11)}
                                    <span class=\"input-group-btn\">
                      ...
                      <div class=\"col-sm-3\">
                        <label>Nascimento</label><br>
                            {$f->input("text", "form-control calendar data-br", "inp-nasc-usuario", "inp-nasc-usuario", "", "Data", "", "Digite a Data")}
                     </div>
                 ...
                 <div class=\"col-sm-12\">                                       
                            {$f->input("checkbox", "", "inp-cadastro-usuario", "inp-cadastro-usuario", "", "", "", "Permitir acesso a cadastros")} <label>Acesso a cadastros</label>
                </div>                           
                ...
                <div class=\"col-sm-12\">
                    <button type=\"button\" id=\"btn-submit-usuario\" class=\"btn btn-success mrg-top\" href=\"Daouser/save\" data-params='{\"nome\":\"inp-nome-usuario\",\"cpf\":\"inp-cpf-usuario\",\"pass\":\"inp-pass-usuario\",\"cad\":\"inp-cadastro-usuario\",\"email\":\"inp-email-usuario\",\"nasc\":\"inp-nasc-usuario\"}'>Salvar </button>

                    <button type=\"button\" id=\"btn-update-usuario\" class=\"btn btn-warning mrg-top\" href=\"Daouser/update\" data-params='{\"id\":\"inp-id\",\"nome\":\"inp-nome-usuario\",\"cpf\":\"inp-cpf-usuario\",\"pass\":\"inp-pass-usuario\",\"cad\":\"inp-cadastro-usuario\",\"email\":\"inp-email-usuario\",\"nasc\":\"inp-nasc-usuario\"}' style=\"display:none;\">Atualizar </button>
