...
echo    
        ...
        <tr>"        
            . "<td class=\"text-nowrap\">
                    <button class=\"btn btn-primary\" name=\"btn-select-usuario\" id=\"btn-select-usuario-{$u['id']}\" data-id=\"{$u['id']}\" data-params='{\"nome\":\"{$u['nome']}\",\"cpf\":\"{$u['CPF']}\",\"cad\":\"{$u['cadastros']}\",\"pass\":\"{$u['pass']}\",\"email\":\"{$u['email']}\",\"nasc\":\"{$u['dtnasc']}\"}' data-modal-close=\"true\">
